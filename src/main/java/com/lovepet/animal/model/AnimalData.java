...
public class AnimalData {
    ...
    private Date animalOpendate;
    private Date animalUpdate;
    private Date animalCreatetime;
    ...
    public void setAnimalAlbumFile(String animalAlbumFile) {
        this.animalAlbumFile = animalAlbumFile;
    }
    ...
    public Date getAnimalOpendate() {
        return animalOpendate;
    }

    public void setAnimalOpendate(Date animalOpendate) {
        this.animalOpendate = animalOpendate;
    }

    public Date getAnimalUpdate() {
        return animalUpdate;
    }

    public void setAnimalUpdate(Date animalUpdate) {
        this.animalUpdate = animalUpdate;
    }

    public Date getAnimalCreatetime() {
        return animalCreatetime;
    }

    public void setAnimalCreatetime(Date animalCreatetime) {
